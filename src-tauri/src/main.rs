...
use crate::filesystem::{
    ...
    git_ignore_add, git_init, git_log, git_log_file, git_merge, git_pull, git_push, git_reflog,
    git_remote_add, git_remote_remove, git_remotes, git_reset, git_revert, git_set_upstream,
    git_show, git_stage, git_stash_apply, git_stash_drop, git_stash_list, git_stash_pop,
    git_stash_push, git_stash_show, git_status, git_tag_create, git_tag_delete, git_tags,
