<template>
  <Modal v-model:show="isVisible" :title="t('about.title')" size="3xl" :close-on-backdrop="false" :close-on-esc="false" @close="closeAbout">
    <div class="space-y-6">
      <!-- 应用图标和标题 -->
      <div class="text-center mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-4 transition-all duration-600 delay-200">{{ t('about.tagline') }}</p>
      ...
      <div class="mb-6 transition-all duration-600 delay-300">
        <div class="bg-gray-50/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-lg p-4 space-y-3 border border-gray-200/50 dark:border-gray-600/50">
          <div class="flex justify-between items-center transform transition-all duration-200 hover:scale-95">
            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">{{ t('about.version') }}</span>
          ...
          <div class="flex justify-between items-center transform transition-all duration-200 hover:scale-95">
            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">{{ t('about.buildTime') }}</span>
            <span class="text-sm text-gray-900 dark:text-white font-mono">{{ buildTime }}</span>
          </div>
          <div class="flex justify-between items-center transform transition-all duration-200 hover:scale-95">
            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">{{ t('about.platform') }}</span>
      ...
      <div class="mb-6 transition-all duration-600 delay-400">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ t('about.coreFeatures') }}</h3>
      ...
      <div class="mb-6 transition-all duration-600 delay-500">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('about.techStack') }}</h3>
